...
const translations: Record<AppLanguage, TranslationTable> = {
  en: {
    ...
    "objectChoice.massAttackStaffBody": "Fire the staff now, or load one compatible card onto it before playing your turn.",
    "objectChoice.massAttackStaffBodyWithCategory": "Fire the staff now, or load one {category} card onto it before playing your turn.",
    ...
    "victory.quitHint": "The activity will close automatically 1 minute after the win.",
  ...
  fr: {
    ...
    "objectChoice.massAttackStaffBody": "Utilisez le bâton maintenant, ou chargez-y une carte compatible avant de jouer votre tour.",
    "objectChoice.massAttackStaffBodyWithCategory": "Utilisez le bâton maintenant, ou chargez-y une carte {category} avant de jouer votre tour.",
    ...
    "victory.quitHint": "L'activit\u00E9 se fermera automatiquement 1 minute apr\u00E8s la victoire.",
